...
public class CreateAdContentPresenter implements BaseMultiLoadedListener<BaseEntity> {
    ...
    private ICreateAdContentView mICreateAdNextPageView;
    private CreateAdContentMode mCreateAdNextPageMode;
    ...
    public CreateAdContentPresenter(ICreateAdContentView iCreateAdNextPageView) {
        ...
        mCreateAdNextPageMode = new CreateAdContentModeImpl((CreateAdContentActivity) iCreateAdNextPageView);
    }
    ...
    public void commit(final String token, AdEntity adEntity, final String title, final String content, final ArrayList<String> selectedPhotos) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            Glide.with((CreateAdContentActivity) mICreateAdNextPageView)
                    .load(path)
                    .asBitmap()
