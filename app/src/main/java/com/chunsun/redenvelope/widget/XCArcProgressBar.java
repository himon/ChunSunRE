...
import com.chunsun.redenvelope.utils.ProgressBarUtils;
...
public class XCArcProgressBar extends View {
    ...
    public XCArcProgressBar(Context context, AttributeSet attrs,
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs,
                R.styleable.XCRoundProgressBar);
        textColor = typedArray.getColor(
                R.styleable.XCRoundProgressBar_textColor, Color.RED);
        textSize = typedArray.getDimension(
                R.styleable.XCRoundProgressBar_textSize, 15);
        max = typedArray.getInteger(R.styleable.XCRoundProgressBar_max, 100);
        isDisplayText = typedArray.getBoolean(
                R.styleable.XCRoundProgressBar_textIsDisplayable, true);
        typedArray.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 绘制底部背景图
        bmpTemp = ProgressBarUtils.decodeCustomRes(getContext(),
                R.drawable.arc_bg);
        ...
        //canvas.drawText(title, centerX - textWidth / 2, height - textSize / 2,
        //paint);
    }
