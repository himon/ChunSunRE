...
public class PhotoPickerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        photoGridAdapter = new PhotoGridAdapter(getActivity(), directories, null);
    ...
    public void setSelectedPhotos(ArrayList<Photo> list) {
        photoGridAdapter.getSelectedPhotoPaths().clear();
        photoGridAdapter.getSelectedPhotoPaths().addAll(list);
        photoGridAdapter.notifyDataSetChanged();
    }
}
